                    ...
                    <div class="col-xl-3 col-md-12">
                        <div class="card user-card2">
                            <div class="card-block text-center">
                                ...
                                <a href="#!" class="text-c-yellow b-b-warning">Change
                                    Your
                                    Risk</a>
                                <div
                            ...
                            <div class="card-block">
                                <div class="row m-b-25">
                                    ...
                                    <div class="col">
                                        ...
                                        <p class="text-muted m-b-0">Lorem Ipsum is simply
                                            dummy
                                            text.</p>
                                        <p class="text-muted m-b-0"><i
                                                class="feather icon-clock m-r-10"></i>2 min
                                            ago
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <h6 class="text-muted f-w-400"><a
                                                        ...
                                                        class="__cf_email__"
                                                        data-cfemail="79131c1700391e14181015571a1614">[email&#160;protected]</a>
                                                </h6>
                                            </div>
                                            <div class="col-sm-6">
